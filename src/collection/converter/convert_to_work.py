...
def convert_instance(instance,bdrc_work_id):
...
def convert_instances(work_file):
    objs =[]
    instances = work_file["instances"]
    for instance in instances:
        obj = convert_instance(instance,work_file["bdrc_work_id"])
        objs.append(obj)
    return objs
...
def convert_to_work(work_file:Dict):
    instance_objs = convert_instances(work_file)
